...
workspaceRoutes.put("/leave/:id", workspace_controller_1.leaveWorkspaceByIdController);
workspaceRoutes.put("/remove/member/:id", workspace_controller_1.removeMemberFromWorkspaceController);
